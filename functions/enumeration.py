...
def enumerate_urls(live_subdomains, domain):
    urls_to_check = [
        "/robots.txt", "/sitemap.xml", "/wp-admin.php", "/index.php", "/home", "/login", "/user", "/dashboard",
        "/admin.php", "/login.php", "/config.php", "/server-status", "/admin", "/administrator", "/wp-config.php", 
        "/shell.php", "/backup.zip", "/uploads/", "/secret/", "/portal/"
    ]
